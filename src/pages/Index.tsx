...
const products = [
  {
    name: "Цельное молоко",
    desc: "Пастеризованное молоко с зауральских степей, богатое натуральными витаминами",
    weight: "1 л",
    tag: "Хит продаж",
  },
  {
...
const values = [
  ...
  { icon: "Droplets", title: "Чистая вода", text: "Наши животные пьют воду из чистых степных родников и природных водоёмов Целинного района" },
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-8 w-full">
          ...
          <div className="flex items-center gap-4 mb-8 opacity-0 animate-fade-up" style={{ animationDelay: "0.25s" }}>
            ...
            <p className="font-montserrat text-sm text-[#faf7f0]/70 tracking-wider max-w-xs">
              Премиум молочные продукты с экологически чистых лугов зауральских степей
            </p>
          </div>
          <button
          ...
          <div className="grid md:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <p className="font-montserrat text-sm text-[#faf7f0]/65 leading-relaxed mb-6">
                Более 20 лет мы выращиваем животных на экологически чистых лугах зауральских степей. Чистый воздух, родниковая вода и сочная трава — основа исключительного вкуса наших продуктов.
              </p>
